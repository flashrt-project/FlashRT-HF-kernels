...
implementation. This package provides a standalone PyTorch/Triton decode path
for consumer Blackwell / SM121.
...
- Public `__all__` exposes only validated decode APIs:
