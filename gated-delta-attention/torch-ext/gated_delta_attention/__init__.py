...
@torch.library.register_fake(add_op_namespace_prefix("gdn_recurrent_inout_stream_bf16"))
...
def gdn_recurrent_inout_stream_bf16(
    q: torch.Tensor,
    k: torch.Tensor,
    v: torch.Tensor,
    g: torch.Tensor,
    ...
    *,
    ...
    if state_out is None:
        state_out = torch.empty_like(state_in)
    ops.gdn_recurrent_inout_stream_bf16(
        q, k, v, g, beta, state_in, state_out, out, bool(use_qk_l2norm)
    )
    return out, state_out
