...
//
// Small-M W4A16 GEMV for SM120 (NVFP4 weight x BF16 activation).
//
...
// Small-M variant. Each weight row is read once and reused for all M rows.
// M must be in [1, 8], and K must be divisible by 16.
