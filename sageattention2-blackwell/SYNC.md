...
- `csrc/permuted_smem.cuh`
- `csrc/qattn/attn_utils.cuh`
- `csrc/qattn/qk_int_sv_f16_core.cuh`
- `csrc/qattn/qk_int_sv_f8_core.cuh`
- `csrc/sage2_blackwell.cu`
- `csrc/sage2_blackwell.cuh`

Local packaging edits:

- Added Tensor-facing PyTorch custom ops in `torch-ext/torch_binding.cpp`.
- Added Python wrappers and fake registrations in `torch-ext/sageattention2_blackwell`.
