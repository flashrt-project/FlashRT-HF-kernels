...
from fa4_cute_runtime.quack.compile_utils import make_fake_tensor as fake_tensor
from fa4_cute_runtime.flashrt_fa4.cute.cache_utils import get_jit_cache
from fa4_cute_runtime.flashrt_fa4.cute.testing import is_fake_mode


if os.environ.get("CUTE_DSL_PTXAS_PATH", None) is not None:
    from fa4_cute_runtime.flashrt_fa4.cute import cute_dsl_ptxas  # noqa: F401
...
from fa4_cute_runtime.flashrt_fa4.cute import fa_logging
from fa4_cute_runtime.flashrt_fa4.cute.cute_dsl_utils import (
    to_cute_tensor, to_cute_aux_tensor, get_aux_tensor_metadata, get_broadcast_dims,
)
from fa4_cute_runtime.flashrt_fa4.cute.flash_fwd_sm100 import FlashAttentionForwardSm100, DescaleTensors
from fa4_cute_runtime.flashrt_fa4.cute.flash_fwd_combine import FlashAttentionForwardCombine
...
from fa4_cute_runtime.flashrt_fa4.cute.sm100_hd256_2cta_fmha_forward import (
    BlackwellFusedMultiHeadAttentionForward,
)

from fa4_cute_runtime.flashrt_fa4.cute.block_sparsity import (
...
# Resolve the dispatch architecture once when the module is imported. The Hub
# wrapper sets FLASH_ATTENTION_ARCH before importing this module, so tracing a
# model never executes device discovery or parses environment strings.
_IMPORT_DEVICE_ARCH = _get_device_arch()
...
def _flash_attn_fwd(
    ...
    arch = _IMPORT_DEVICE_ARCH if _arch is None else _arch
