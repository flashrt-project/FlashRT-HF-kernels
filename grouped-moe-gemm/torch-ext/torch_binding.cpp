...
void grouped_nvfp4_gemm_bf16_out(
  ...
  // The CUTLASS block-scaled MMA tiles are SM120-only and assert on sm_110a
  // (Thor). Route non-SM120 devices (and FLASHRT_FORCE_SIMT diagnostics) to
  // the portable pure-SIMT reference; SM120 keeps the native tiles.
