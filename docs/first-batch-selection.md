...
| --- | --- | --- |
| `flashrt-nvfp4` | NVFP4 scale-factor layout helpers, W4A16 GEMM bias+GELU epilogues, Stream-K down GEMM | Blackwell low-bit support is still sparse in the public ecosystem; layout helpers make the rest of the kernels usable. |
