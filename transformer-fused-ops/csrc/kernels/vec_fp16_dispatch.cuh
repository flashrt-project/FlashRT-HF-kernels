...
using QuantizeFp8Bf16Dispatch = decltype(&quantize_fp8_static_bf16_vec);
using LayerNormFp8Bf16Dispatch = decltype(&layer_norm_fp8_static_bf16_vec);
using GateGegluFp8Bf16Dispatch =
    decltype(&gate_geglu_merged_fp8_static_bf16_vec);
...
extern QuantizeFp8Bf16Dispatch quantize_fp8_bf16_dispatch;
extern LayerNormFp8Bf16Dispatch layer_norm_fp8_bf16_dispatch;
extern GateGegluFp8Bf16Dispatch gate_geglu_fp8_bf16_dispatch;
